...
- **Additional Information:** For complete VRS invitation details, seeding information, tournament format, and prize pool distribution, see the [Additional Information document](dfrag-logitech-g-pro-series-additional-info.md).
...
Any participant with an active ban from FACEIT, ESL or Valve is prohibited from participating in the tournament.

**Disqualification Rules:** All disqualification rules are published in this ruleset and the [Additional Information document](dfrag-logitech-g-pro-series-additional-info.md) as required by Valve Tournament Operation Requirements. Any disqualification decisions will be published at the time of enforcement. Rules are objective, transparent, and applied equally to all participants.
...
- Not applicable. This tournament does not include a Closed Qualifier stage.
...
The total prize pool is **$20,000 AUD**.
...
- Any roster that **accepts a Direct VRS Invite** or **Wildcard Invite** to the Offline LAN Main Event, or that receives a **confirmed Offline LAN Main Event slot** through a fallback Open Qualifier, and then is unable or unwilling to travel to or attend the LAN, is subject to a **financial fine**.
...
- The Tournament Operator is free to restrict a Participant's participation in other Tournaments while the affected Participant is on location at this Tournament's LAN event and within the published date boundaries of the Tournament (October 15–18, 2026).

---

## Non-Discriminatory Treatment

- All Participants of the same stage of the Tournament shall receive equal treatment in all aspects of the event, regardless of whether they entered through Direct VRS Invite, Wildcard Invite, or Open Qualifier.
...
Conflict of interest disclosures for this event are published in the [Additional Information document](dfrag-logitech-g-pro-series-additional-info.md).
