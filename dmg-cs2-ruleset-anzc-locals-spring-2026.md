...
- **Event Dates:** October 10–11, 2026
...
- **Additional Information:** For complete registration, seeding, tournament format, and prize pool distribution details, see the [Additional Information document](anzc-locals-spring-2026-additional-info.md).
- **Additional Information Published:** August 17, 2026
...
- [Registration and Qualification](#registration-and-qualification)
  - [High Seed Registration](#high-seed-registration)
  - [High Seed LAN Allocation](#high-seed-lan-allocation)
...
- ANZC LOCALS SPRING 2026 will not issue Direct VRS Invites.
- All teams must enter through High Seed Registration.
- A team's **Core Members** are the five (5) players submitted and confirmed during High Seed Registration.
- For teams allocated a High Seed LAN slot through High Seed Registration and VRS seeding, Core Members are the five (5) players confirmed during High Seed Registration and used for VRS seeding validation.
- For teams entering through the Online Open Qualifier, Core Members are the five (5) players confirmed during High Seed Registration and used in the Online Open Qualifier.
...
- Registration / Roster Lock is **October 9, 2026, 23:59 AEST**.
...
- Roster Lock applies to both:
  - teams seeking a High Seed LAN slot through High Seed Registration and VRS seeding
...
ANZC LOCALS SPRING 2026 is a Ranked Tier 2 tournament with no Direct VRS Invites.

All teams must enter through High Seed Registration. No roster will be advanced through a Direct VRS Invite process.

### High Seed Registration
...
- High Seed Registration order and timestamps will be publicly inspectable via **GOOGLE SHEETS**.
...
- The Offline LAN Main Event will be held at **The DFRAG Studio**, Brisbane, Queensland, Australia, from **October 10–11, 2026**.
- The Offline LAN Main Event will feature 8 teams:
  - 4 teams allocated a High Seed LAN slot through High Seed Registration using the published VRS seeding snapshot
  - 4 teams qualified through the Online Open Qualifier
- LAN format:
  - **October 10, 2026 – Group Stage:** 2 groups of 4; GSL format; opening matches Best-of-1; all following matches Best-of-3; top 2 from each group advance
  - **October 11, 2026 – Finals:** 4 teams; double-elimination bracket; opening matches Best-of-1; all following matches Best-of-3
...
- **MVP Hardware** may be awarded according to an objective MVP criterion applied equally to eligible athletes in the Offline LAN Main Event, as set out in the Additional Information document.
- **Travel support:** None, unless otherwise stated in a published update to the Additional Information.
- **Accommodation support:** None, unless otherwise stated in a published update to the Additional Information.
...
- All teams that receive a confirmed Offline LAN Main Event slot must pay the published **LAN participation fee**.
- The LAN participation fee amount, payment method, and refund policy (if any) will be clearly stated at Offline LAN Main Event slot confirmation or in a published update to the Additional Information.
- The LAN participation fee applies only after a roster has been allocated a High Seed LAN slot or qualified through the Online Open Qualifier.
...
- The LAN participation fee is not prize compensation and does not alter the prize distribution.
- The LAN participation fee does not include travel or accommodation unless explicitly stated under Prize Pool and Compensation in the Additional Information.
...
#### Confirmed LAN slot non-attendance

- Any roster that receives a **confirmed Offline LAN Main Event slot** through High Seed Registration or the Online Open Qualifier, and then is unable or unwilling to travel to or attend the LAN, is subject to a **financial fine**.
- This fine applies **regardless of notification period**, including late notice, early notice, or notice given after slot confirmation.
...
- The Tournament Operator is free to restrict a Participant's participation in other Tournaments while the affected Participant is on location at this Tournament's LAN event and within the published date boundaries of the Offline LAN Main Event (**October 10–11, 2026**).

---

## Non-Discriminatory Treatment

- All Participants of the same stage of the Tournament shall receive equal treatment in all aspects of the event, regardless of whether they entered the Offline LAN Main Event through High Seed Registration or the Online Open Qualifier.
...
- **Broadcast Rights:**
  ...
  - DFRAG will broadcast all coverage of ANZC LOCALS SPRING 2026 from The DFRAG Studio.
...
The Tournament Organiser may make rulings where this ruleset is silent or ambiguous in order to protect competitive integrity and the spirit of the rule. Admin discretion cannot be used to alter published High Seed Registration criteria, High Seed LAN allocation, Online Open Qualifier qualification paths, prize distribution, or any requirement set out in the Additional Information document.
